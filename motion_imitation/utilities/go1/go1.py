...
Go1_DEFAULT_ABDUCTION_ANGLE = 0
Go1_DEFAULT_HIP_ANGLE = 0.9
Go1_DEFAULT_KNEE_ANGLE = -1.8
NUM_LEGS = 4
INIT_MOTOR_ANGLES = np.array([
    Go1_DEFAULT_ABDUCTION_ANGLE,
    Go1_DEFAULT_HIP_ANGLE,
    Go1_DEFAULT_KNEE_ANGLE
] * NUM_LEGS)
